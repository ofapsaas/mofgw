...
| 5 | Clave acct2-go con 401 upstream | ⏳ PENDIENTE (validar/rotar) | MEDIA | state file previo + deploy | Hallazgo pre-existente (no del replanteo): la key del provider acct2-go devuelve 401. No bloquea (fallback cubre) pero hay que validarla. |
