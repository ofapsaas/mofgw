...
- 2026-08-11: #25-#27 agregadas (EPIC-010: thinkingProfile fragilidad aceptada del review 010-002; qwen max_output 64K→128K cerrada y verificada en deploy; bodyHasExplicitEffort opcional). #4 cerrada completa (metadata flash-0731 en prod). #26 verificado empíricamente (bailian acepta max_tokens 131072).
